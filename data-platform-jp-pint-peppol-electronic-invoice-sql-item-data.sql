...
(
	...
	`InvoiceLineChargeAmount`                                           varchar(13) DEFAULT NULL,
	...
	`ActualDeliveryDate`                                                varchar(80) DEFAULT NULL,
    ...
    `TAXCategoryCode`                                                   varchar(2) DEFAULT NULL,
    `TAXCategoryRate`                                                   varchar(6) DEFAULT NULL, 
