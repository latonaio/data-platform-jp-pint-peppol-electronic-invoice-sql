CREATE TABLE `jp_pint_peppol_electronic_invoice_item_partner_data`
(
    ...
    CONSTRAINT `JPPINTPeppolElectronicInvoiceItemPartnerData_fk` FOREIGN KEY (`InvoiceNumber`, `InvoiceLineIdentifier`) REFERENCES `jp_pint_peppol_electronic_invoice_item_data` (`InvoiceNumber`, `InvoiceLineIdentifier`)
) ENGINE = InnoDB
