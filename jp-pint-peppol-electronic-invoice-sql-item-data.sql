CREATE TABLE `jp_pint_peppol_electronic_invoice_item_data`
(
   ...
   CONSTRAINT `JPPINTPeppolElectronicInvoiceItemData_fk` FOREIGN KEY (`InvoiceNumber`) REFERENCES `jp_pint_peppol_electronic_invoice_header_data` (`InvoiceNumber`)
) ENGINE = InnoDB
